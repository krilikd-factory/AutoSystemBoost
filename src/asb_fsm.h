...
static const asb_profile_bounds_t g_profile_bounds[3] = {
    ...
    {
        .floor = {
            .cpu_max    = { 2304000, 2611200, 0 },   /* = CPU_CAP */
            .cpu_min    = { 1190400, 1113600, 0 },   /* = CPU_MIN */
            .gpu_max_pct = 35, .gpu_min_pct = 10,    /* half of GPU_MAX (70/2=35) */
            .ravg_ticks = 2, .idle_enough = 10,
            .uclamp_top_max = 68, .uclamp_bg_max = 45
        },
        .ceil = {
            .cpu_max    = { 2956800, 3302400, 0 },   /* = CPU_MAX */
            .cpu_min    = { 2304000, 2611200, 0 },   /* = CPU_CAP (keep min high during GAMING) */
            .gpu_max_pct = 70, .gpu_min_pct = 26,    /* = GPU_MAX_PCT from .sh */
            .ravg_ticks = 2, .idle_enough = 8,
            .uclamp_top_max = 84, .uclamp_bg_max = 62
        }
    }
};
