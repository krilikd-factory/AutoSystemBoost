...
static const asb_profile_bounds_t g_profile_bounds[3] = {
     ...
     */
    {
        ...
        .ceil = {
            .cpu_max    = { 1804800, 2208000, 0 },   /* = CPU_MAX */
            .cpu_min    = { 1132800, 1113600, 0 },   /* = CPU_CAP */
            .gpu_max_pct = 50, .gpu_min_pct = 0,     /* vendor always overrides min, skip */
            .ravg_ticks = 8, .idle_enough = 95,
            .uclamp_top_max = 58, .uclamp_bg_max = 40
        }
    },
     ...
     * From performance.sh: CPU_MIN={1190400, 1113600}  CPU_CAP={2611200, 3072000}
     *                      CPU_MAX={3302400, 3686400}  GPU_MAX=78%
     *
     * V40 tune for sustained gaming (30-60 min sessions without thermal throttle):
     * Peak P-cluster lowered 4608→3686 MHz to stay below vendor PowerHAL's
     * 59°C trigger. Actual sustained 3072 MHz (was 2976) + raised UCL_TOP cap
     * keeps headroom for 120 FPS frametime budget. GPU 78% (was 84%) keeps
     * Adreno in efficient zone where heat/perf curve is best.
     */
    {
        .floor = {
            .cpu_max    = { 2611200, 3072000, 0 },   /* = CPU_CAP */
            .cpu_min    = { 1190400, 1113600, 0 },   /* = CPU_MIN */
            .gpu_max_pct = 39, .gpu_min_pct = 10,    /* half of GPU_MAX (78/2≈39) */
            .ravg_ticks = 2, .idle_enough = 10,
            .uclamp_top_max = 75, .uclamp_bg_max = 50
        },
        .ceil = {
            .cpu_max    = { 3302400, 3686400, 0 },   /* = CPU_MAX */
            .cpu_min    = { 2611200, 3072000, 0 },   /* = CPU_CAP (keep min high during GAMING) */
            .gpu_max_pct = 78, .gpu_min_pct = 30,    /* = GPU_MAX_PCT from .sh */
            .ravg_ticks = 2, .idle_enough = 8,
            .uclamp_top_max = 92, .uclamp_bg_max = 70
        }
    }
};
