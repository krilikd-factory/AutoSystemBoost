...
static const asb_profile_bounds_t g_profile_bounds[3] = {
     ...
     * From performance.sh: CPU_MIN={1190400, 1113600}  CPU_CAP={2611200, 2956800}
     *                      CPU_MAX={3302400, 3686400}  GPU_MAX=74%
     *
     * V40 tune for sustained gaming (30-60 min sessions without thermal throttle).
     * Thermal envelope target: peak ≤58°C, sustained ≤48°C. Caps calibrated to
     * stay under vendor PowerHAL's reactive thermal triggers. Synthetic peak
     * scores lower vs vendor defaults; real game sessions stable for 60+ min.
     */
    {
        .floor = {
            .cpu_max    = { 2611200, 2956800, 0 },   /* = CPU_CAP */
            .cpu_min    = { 1190400, 1113600, 0 },   /* = CPU_MIN */
            .gpu_max_pct = 37, .gpu_min_pct = 10,    /* half of GPU_MAX (74/2=37) */
            .ravg_ticks = 2, .idle_enough = 10,
            .uclamp_top_max = 72, .uclamp_bg_max = 48
        },
        .ceil = {
            .cpu_max    = { 3302400, 3686400, 0 },   /* = CPU_MAX */
            .cpu_min    = { 2611200, 2956800, 0 },   /* = CPU_CAP (keep min high during GAMING) */
            .gpu_max_pct = 74, .gpu_min_pct = 28,    /* = GPU_MAX_PCT from .sh */
            .ravg_ticks = 2, .idle_enough = 8,
            .uclamp_top_max = 88, .uclamp_bg_max = 66
        }
    }
};
