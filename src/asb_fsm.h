...
static const asb_profile_bounds_t g_profile_bounds[3] = {
     ...
     * CPU_MIN={307200, 614400}  CPU_CAP={614400, 921600}  CPU_MAX={1132800, 998400}  GPU_MAX=15%
     */
    {
        .floor = {
            .cpu_max    = {  614400,  921600, 0 },   /* = CPU_CAP */
            .cpu_min    = {  307200,  614400, 0 },   /* = CPU_MIN */
            .gpu_max_pct = 5, .gpu_min_pct = 0,
            .ravg_ticks = 8, .idle_enough = 95,
            .uclamp_top_max = 10, .uclamp_bg_max = 5
        },
        .ceil = {
            .cpu_max    = { 1132800,  998400, 0 },   /* = CPU_MAX */
            .cpu_min    = {  614400,  921600, 0 },   /* = CPU_CAP */
            .gpu_max_pct = 15, .gpu_min_pct = 0,     /* = GPU_MAX_PCT from .sh */
            .ravg_ticks = 8, .idle_enough = 95,
