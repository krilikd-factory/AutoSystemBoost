...
static const asb_profile_bounds_t g_profile_bounds[3] = {
     ...
     */
    {
        ...
        .ceil = {
            ...
            .gpu_max_pct = 55, .gpu_min_pct = 0,     /* vendor always overrides min, skip */
            .ravg_ticks = 8, .idle_enough = 95,
     ...
     */
    {
        .floor = {
            ...
            .gpu_max_pct = 42, .gpu_min_pct = 0,     /* vendor always overrides min, skip */
        ...
        .ceil = {
            ...
            .gpu_max_pct = 85, .gpu_min_pct = 0,     /* vendor always overrides min, skip */
