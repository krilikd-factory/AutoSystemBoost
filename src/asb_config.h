...
typedef struct {
    ...
    /* V39r8: thermal_pwrlevel monitoring rate control.
...
static inline void asb_config_defaults(asb_runtime_config_t *c) {
    ...
    /* V39r7: HEAVY load thresholds raised for Snapdragon 8 Elite Gen 5.
     *
    ...
    /* V39r7: same recalibration for battery profile */
    c->bat_heavy_load_enter = 20.0f;     /* was 15 */
    c->bat_moderate_load_enter = 14.0f;  /* was 10 */
    c->log_level = 0;

    /* V39r8: thermal_pwrlevel monitoring */
