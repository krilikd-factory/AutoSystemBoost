#pragma once
/* ASB V22 runtime config: key=value parser */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
typedef struct {
    ...
    int   sustained_temp_enter;  /* °C — SUSTAINED entry threshold (default 65) */
    int   sustained_temp_exit;   /* °C — SUSTAINED exit hysteresis (default 55, < enter) */
    ...
    int   thermal_throttle_temp; /* °C — throttle detection threshold for SD8Elite (default 65) */
    /* Gap-aware SUSTAINED */
...
static inline void asb_config_defaults(asb_runtime_config_t *c) {
    ...
    c->sustained_temp_exit = 55; /* hysteresis 10°C — do not exit while t > 55 */
    c->heavy_gpu_exit      = 25;
