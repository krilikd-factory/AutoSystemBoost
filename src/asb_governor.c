...
#define g_asb_cfg.action_waste_threshold 5
...
#define g_asb_cfg.quiet_entry_ticks  60       /* ~10min at TIMER_DEEP_S=10s */
#define g_asb_cfg.quiet_fast_ticks   30       /* ~5min with clean-night reward */
#define g_asb_cfg.quiet_tick_s       20       /* tick interval in ultra-quiet mode */
