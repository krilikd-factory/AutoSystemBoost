                               ...
                               char *out, int outlen)
{
    ...
    snprintf(out, outlen,
        ...
        "\"gpu\":%d,\"load\":%.2f,"
        "\"cpu_max\":[%d,%d,%d],"
        "\"thermal\":%d,\"temp\":%d,\"temp_valid\":%d,\"temp_age_s\":%d,"
        "\"skin_temp\":%d,\"surface_hotspot\":%d,"
...
static void session_history_append_ex(const asb_fsm_t *fsm, const char *reason) {
    ...
    fprintf(wf,
        ...
        "\"avg_gap\":%d,\"max_temp\":%d,\"skin_max_temp\":%d,\"surface_max_temp\":%d,\"degraded\":%d,"
        ...
        fsm->ses_time_sustained_sec,
        avg_gap, fsm->ses_max_temp, fsm->ses_max_skin_temp, fsm->ses_max_surface_temp, fsm->ses_auto_degraded,
                        ...
                        if (fsm.sustained_reason == 1) {
                            ...
                            if (metrics.therm.headroom_pct > 0 && metrics.therm.headroom_pct < 50) {
                                ...
                                const char *_sus_reason =
                                    ...
                                    metrics.therm.hard_clamp ? "hard_clamp" : "unknown";
                                asb_log("enter_sustained: %s actual_t=%ddegC (thresh=%d) headroom=%d%% soft=%d hard=%d",
                                        _sus_reason,
                                        metrics.therm.cpu_max_c,
