    ...
    while (g_running) {
        ...
        static time_t g_last_profile_sync = 0;
        {
            ...
            if (_now - g_last_state_touch >= 60) {
                /* V40-diag-3: profile drift safety net. apply_profile.sh
             ...
             */
            {
                ...
                if (g_asb_cfg.thermal_pwrlevel_audit_log_s > 0) {
                    ...
                    if (now_s - g_thermal_pl_last_audit >= g_asb_cfg.thermal_pwrlevel_audit_log_s) {
                        ...
                        /* V40-diag: also flush vendor-override audit alongside */
                        char vo_buf[256];
                ...
                /* V40-diag: vendor override detection — check if vendor
