...
static void metrics_read_battery(asb_battery_t *b) {
    b->current_ua   = sysfs_read_int(PATH_BATT_CURRENT, 0);
...
static void metrics_read_cpu(asb_cpu_t *c) {
    ...
    /* per-policy freq */
    static const char *cur_paths[3] = {
        PATH_CPU_POLICY0 "/scaling_cur_freq",
        PATH_CPU_POLICY4 "/scaling_cur_freq",
        PATH_CPU_POLICY7 "/scaling_cur_freq",
    };
    static const char *max_paths[3] = {
        PATH_CPU_POLICY0 "/scaling_max_freq",
        PATH_CPU_POLICY4 "/scaling_max_freq",
        PATH_CPU_POLICY7 "/scaling_max_freq",
    };
    for (int i = 0; i < 3; i++) {
