...
/* V33: priority-based thermal discovery. cpullc (little core) jumps 25-65degC
 * depending on core sleep state -- terrible for governor decisions.
 * Prefer stable SoC/cluster sensors, fall back to cpullc only as last resort. */
