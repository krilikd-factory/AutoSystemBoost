...
"$CC" "${CFLAGS[@]}" "$SCRIPT_DIR/asb_governor.c" "${LDFLAGS[@]}" -o "$OUT_DIR/asb_governor"
"$STRIP" "$OUT_DIR/asb_governor" || true
chmod 0755 "$OUT_DIR/asb_governor"
ls -lh "$OUT_DIR/asb_governor"
