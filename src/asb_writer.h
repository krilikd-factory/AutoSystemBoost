...
/* V39r5a: GPU control on Qualcomm KGSL uses POWER LEVELS, not Hz values.
 *
...
/* V39r8: thermal_pwrlevel monitoring infrastructure.
 *
...
static void writer_discover_gpu_paths(void) {
    ...
    /* V39r8: thermal_pwrlevel discovery — vendor thermal cap, read-only for us
...
/* V39r8: read thermal_pwrlevel using cached fd + pread (single syscall).
