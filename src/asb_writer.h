...
/* V40-diag: vendor pwrlevel override detector.
 *
...
typedef struct {
    ...
    int  initialized;
    /* V40-diag: last actual pwrlevel values we wrote, for vendor-override detection */
...
/* V40-diag: vendor-override audit counters. Incremented when periodic re-read
