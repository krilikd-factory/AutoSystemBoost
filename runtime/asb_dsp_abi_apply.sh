...
# The AIDL/legacy choice is capability-based: the installer stages ABI-matched
# prebuilt libraries, so a missing fingerprint marker must not silently disable a
# known-good DSP chain on an otherwise compatible device.
