...
asb_map_profile_vars() {
  ...
  _P_UDP_MEM="$NET_UDP_MEM"
  _P_TCP_MTU_PROBING="$NET_TCP_MTU_PROBING"
  _P_TCP_THIN="$NET_TCP_THIN"
  _P_TCP_RTO_MAX="$NET_TCP_RTO_MAX"
  _P_HAPPY_EYEBALLS="$NET_HAPPY_EYEBALLS"
}
