...
[ "$(wc -l < "$TMP/cards")" = "65" ] || fail "expected 65 WebUI cards, got $(wc -l < "$TMP/cards")"
...
echo 'PASS config ownership registry contract (174 keys; 26 user, 36 advanced, 113 internal)'
