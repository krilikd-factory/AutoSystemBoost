...
_camera_tier="generic"; _audio_tier="generic"; _net_tier="generic"; _overlay_tier="generic"
...
printf '"tiers":{"camera":"%s","audio":"%s","network":"%s","overlay":"%s"}' \
  "$(_json "$_camera_tier")" "$(_json "$_audio_tier")" "$(_json "$_net_tier")" "$(_json "$_overlay_tier")"
printf '}\n'
